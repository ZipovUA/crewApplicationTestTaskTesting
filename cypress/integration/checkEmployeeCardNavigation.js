// TOD: we need to add and use own cy command getEmployeeCardByName(columnName, employeeName) 
...
describe('Check employee card navigation', function(){
    ...
    it('Navigate card from "Applied" to "Interviewed" state', function(){
        //cy.getEmployeeCardByName('applied', 'emma steward');
    ...
    it('Navigate card from "Interviewed" to "Hired" state', function(){
        cy.get(dataColumns.applied.first.toolBar.goForwardButton).click();
    ...
    it('Navigate card back from "Hired" to "Inverviewed" state', function(){
    ...
    it('Navigate card back from "Interviewed" to "Applied" state', function(){
        cy.get(dataColumns.applied.first.toolBar.goForwardButton).click();
